...
const createTripCostTemplate = () => {
  return (
    `<p class="trip-info__cost">
      Total: &euro;&nbsp;
      <span class="trip-info__cost-value">0</span>
    </p>`
  );
};
...
const mainTripInfo = document.querySelector('.trip-info');
const infoTrip = mainTrip.querySelector('.trip-info__main');
